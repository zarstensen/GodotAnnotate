...
var canvas_image_dialog: FileDialog = preload("res://addons/GodotAnnotate/res/canvas_image_dialog.tscn").instantiate()
var upscale_factor_dialog: ConfirmationDialog = preload("res://addons/GodotAnnotate/res/upscale_factor_dialog.tscn").instantiate()
